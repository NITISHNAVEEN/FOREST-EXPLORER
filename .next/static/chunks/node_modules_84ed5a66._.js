...
"[project]/node_modules/lucide-react/dist/esm/icons/heart-crack.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const HeartCrack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("HeartCrack", __iconNode);
;
 //# sourceMappingURL=heart-crack.js.map
}}),
"[project]/node_modules/lucide-react/dist/esm/icons/heart-crack.js [app-client] (ecmascript) <export default as HeartCrack>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lucide-react/dist/esm/icons/glass-water.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const GlassWater = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("GlassWater", __iconNode);
;
 //# sourceMappingURL=glass-water.js.map
}}),
"[project]/node_modules/lucide-react/dist/esm/icons/glass-water.js [app-client] (ecmascript) <export default as GlassWater>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/react-xarrows/lib/index.js [app-client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
(function webpackUniversalModuleDefinition(root, factory) {
    if ("TURBOPACK compile-time truthy", 1) module.exports = factory(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/lodash/lodash.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/prop-types/index.js [app-client] (ecmascript)"));
    else {
        "TURBOPACK unreachable";
    }
    ...
    return /******/ function() {
        ...
        /******/ var __webpack_modules__ = {
            /***/ "./src/Xarrow/utils/buzzier.js": function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
 ...
 */ var buzzierMinSols = function buzzierMinSols(p1, p2, p3, p4) {
            ...
            /***/ },
            /***/ "./src/Xarrow/Xarrow.tsx": function(__unused_webpack_module, exports, __webpack_require__) {
     ...
     * */ react_1.useLayoutEffect({
                        "Xarrow.useLayoutEffect": function() {
                    ...
                    if (animateDrawing && drawAnimEnded == false) {
                        ...
                        if (animateDrawing < 0) {
                            _a = [
                                animEndValue,
                                animStartValue
                            ], animStartValue = _a[0], animEndValue = _a[1];
                    ...
                    react_1.useLayoutEffect({
                        "Xarrow.useLayoutEffect": function() {
                            if (lineRef.current) setSt({
                                "Xarrow.useLayoutEffect": function(prevSt) {
                                    var _a, _b;
                    ...
                    react_1.useEffect({
                        "Xarrow.useEffect": function() {
                            var monitorDOMchanges = {
                                "Xarrow.useEffect.monitorDOMchanges": function() {
                                    window.addEventListener('resize', forceRerender);
                                    var handleDrawAmimEnd = {
                                        "Xarrow.useEffect.monitorDOMchanges.handleDrawAmimEnd": function() {
                                            var _a, _b;
                                    ...
                                    }["Xarrow.useEffect.monitorDOMchanges.handleDrawAmimEnd"];
                                    var handleDrawAmimBegin = {
                                        "Xarrow.useEffect.monitorDOMchanges.handleDrawAmimBegin": function() {
                                            return headRef.current.style.opacity = '0';
                                        }
                                    }["Xarrow.useEffect.monitorDOMchanges.handleDrawAmimBegin"];
                                    ...
                                    })["Xarrow.useEffect.monitorDOMchanges"];
                                }
                            }["Xarrow.useEffect.monitorDOMchanges"];
            ...
            /***/ },
            /***/ "./src/Xarrow/anchors.ts": function(module1, exports, __webpack_require__) {
                ...
                if (__webpack_require__.c[__webpack_require__.s] === module1) {
            ...
            /***/ },
            /***/ "./src/Xarrow/propTypes.ts": function(__unused_webpack_module, exports, __webpack_require__) {
                var __importDefault = this && this.__importDefault || function(mod) {
                    return mod && mod.__esModule ? mod : {
                        "default": mod
                    };
                ...
                var XarrowPropTypes = {
                    ...
                    labels: prop_types_1.default.oneOfType([
                        _pLabelType,
                        pLabelsType
                    ]),
                    ...
                    dashness: prop_types_1.default.oneOfType([
            ...
            /***/ },
            /***/ "./src/Xarrow/useXarrowProps.ts": function(__unused_webpack_module, exports, __webpack_require__) {
                var __assign = this && this.__assign || function() {
                    __assign = Object.assign || function(t) {
                        for(var s, i = 1, n = arguments.length; i < n; i++){
                            s = arguments[i];
                ...
                var parseLabels = function(label) {
                    ...
                    if (label) {
                        if (typeof label === 'string' || react_1.default.isValidElement(label)) parsedLabel.middle = label;
                        else {
                ...
                var parseAnchor = function(anchor) {
                    // convert to array
                    var anchorChoice = Array.isArray(anchor) ? anchor : [
                        anchor
                    ];
                ...
                var parseEdgeShape = function(svgEdge) {
                    if (typeof svgEdge == 'string') {
                        if (svgEdge in constants_1.arrowShapes) svgEdge = constants_1.arrowShapes[svgEdge];
                        else {
 ...
 */ var useXarrowProps = function(userProps, refs) {
                    ...
                    var _loop_1 = function(propName) {
                        react_1.useLayoutEffect({
                            "useXarrowProps._loop_1.useLayoutEffect": function() {
                                var _a;
                        ...
                        }["useXarrowProps._loop_1.useLayoutEffect"], propsDeps[propName].map({
                            "useXarrowProps._loop_1.useLayoutEffect": function(name) {
                                return userProps[name];
                            }
                        }["useXarrowProps._loop_1.useLayoutEffect"]));
                    };
                    ...
                    useDeepCompareEffect({
                        "useXarrowProps.useDeepCompareEffect": function() {
                    ...
                    }["useXarrowProps.useDeepCompareEffect"], [
                        startPos
                    ]);
                    ...
                    react_1.useLayoutEffect({
                        "useXarrowProps.useLayoutEffect": function() {
                            // console.log('svg shape changed!');
                            shouldUpdatePosition.current = true;
                            setValVars(__assign({}, valVars));
                        }
                    }["useXarrowProps.useLayoutEffect"], [
            ...
            /***/ },
            /***/ "./src/Xarrow/utils/GetPosition.tsx": function(__unused_webpack_module, exports, __webpack_require__) {
                var __importDefault = this && this.__importDefault || function(mod) {
                    return mod && mod.__esModule ? mod : {
                        "default": mod
                    };
 ...
 * */ var getPosition = function(xProps, mainRef) {
                    ...
                    var startPoint = lodash_1.default.pick(chosenStart, [
                        'x',
                        'y'
                    ]), endPoint = lodash_1.default.pick(chosenEnd, [
                        'x',
                        'y'
                    ]);
                    ...
                    if ([
                        'left',
                        'right'
                    ].includes(startAnchorPosition)) selectedCurviness += 'h';
                    else if ([
                        'bottom',
                        'top'
                    ].includes(startAnchorPosition)) selectedCurviness += 'v';
                    else if (startAnchorPosition === 'middle') selectedCurviness += 'm';
                    if ([
                        'left',
                        'right'
                    ].includes(endAnchorPosition)) selectedCurviness += 'h';
                    else if ([
                        'bottom',
                        'top'
                    ].includes(endAnchorPosition)) selectedCurviness += 'v';
            ...
            /***/ },
            /***/ "./src/Xarrow/utils/index.ts": function(__unused_webpack_module, exports) {
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
            ...
            /***/ },
            /***/ "./src/Xwrapper.tsx": function(__unused_webpack_module, exports, __webpack_require__) {
                var __createBinding = this && this.__createBinding || (Object.create ? function(o, m, k, k2) {
                    if (k2 === undefined) k2 = k;
                    Object.defineProperty(o, k2, {
                        enumerable: true,
            ...
            /***/ },
            /***/ "./src/constants.tsx": function(__unused_webpack_module, exports, __webpack_require__) {
                var __importDefault = this && this.__importDefault || function(mod) {
                    return mod && mod.__esModule ? mod : {
                        "default": mod
                    };
            ...
            /***/ },
            /***/ "./src/types.ts": function(__unused_webpack_module, exports) {
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
            /***/ },
            /***/ "./src/useXarrow.tsx": function(__unused_webpack_module, exports, __webpack_require__) {
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
                ...
                var useXarrow = function() {
                    ...
                    // );
                    react_1.useLayoutEffect({
                        "useXarrow.useLayoutEffect": function() {
                            updateXarrow();
                        }
                    }["useXarrow.useLayoutEffect"]);
                    return reRender;
                };
                exports.default = useXarrow;
            /***/ },
            /***/ "lodash": function(module1) {
                module1.exports = __WEBPACK_EXTERNAL_MODULE_lodash__;
            /***/ },
            /***/ "prop-types": function(module1) {
                module1.exports = __WEBPACK_EXTERNAL_MODULE_prop_types__;
            /***/ },
            /***/ "react": function(module1) {
        ...
        /******/ /******/ /* webpack/runtime/node module decorator */ /******/ !function() {
            /******/ __webpack_require__.nmd = function(module1) {
                /******/ module1.paths = [];
...
//# sourceMappingURL=node_modules_84ed5a66._.js.map