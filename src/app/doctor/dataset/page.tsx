...
export default function DatasetPage() {
  const trainingData = patientData.slice(0, 8);
  const testingData = patientData.slice(8);
              ...
              <Table>
                ...
                <TableBody>
                  {patientData.map((patient, index) => (
                    <TableRow key={index} className={cn({'bg-blue-50 dark:bg-blue-900/20': index >= 8})}>
           ...
           <Card>
            ...
            <CardContent className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center">
                    <div className="flex items-center gap-2">
                       ...
                       <div>
                         ...
                         <p className="text-sm">{patientData.length} records</p>
                       </div>
                    </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  The model is a <strong>Random Forest</strong>, which is a collection of many individual Decision Trees. Each tree is trained on a random subset of the training data and features (like blood pressure, cholesterol, etc.). When making a prediction, all trees "vote", and the majority outcome becomes the final prediction. This makes the model more accurate and robust for risk assessment.
                </p>
